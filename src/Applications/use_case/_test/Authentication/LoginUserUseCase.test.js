...
const LoginUserUseCase = require('../../Authentication/LoginUserUseCase')
...
describe('GetAuthenticationUseCase', () => {
  it('should orchestrating the get authentication action correctly', async () => {
    ...
    mockEncryptionHelper.comparePassword = jest
      .fn()
    ...
    expect(mockEncryptionHelper.comparePassword).toBeCalledWith(
      'secret',
      'encrypted_password',
    )
